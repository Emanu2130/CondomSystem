...
// Define page object
$comprobantes_tipos_addopt = new ccomprobantes_tipos_addopt();
$Page =& $comprobantes_tipos_addopt;

// Page init processing
$comprobantes_tipos_addopt->Page_Init();

// Page main processing
$comprobantes_tipos_addopt->Page_Main();
?>
...
<?php $comprobantes_tipos_addopt->ShowMessage() ?>
<form name="fcomprobantes_tiposaddopt" id="fcomprobantes_tiposaddopt" action="comprobantes_tiposaddopt.php" method="post" onsubmit="return comprobantes_tipos_addopt.ValidateForm(this);">
<p>
<input type="hidden" name="t" id="t" value="comprobantes_tipos">
<input type="hidden" name="a_addopt" id="a_addopt" value="A">
<table class="ewTableAddOpt">
	<tr>
		<td>Nombre Tipo<span class="ewRequerido">&nbsp;*</span></td>
		<td><span id="el_nombre_tipo">
...
// Page Class
//
class ccomprobantes_tipos_addopt {
	...
	// Page Object Name
	var $PageObjName = 'comprobantes_tipos_addopt';
	...
	//  - open connection
	//
	function ccomprobantes_tipos_addopt() {
		global $conn;
...
//
	function Page_Main() {
		...
		if ($objForm->GetValue("a_addopt") <> "") {
			$comprobantes_tipos->CurrentAction = $objForm->GetValue("a_addopt"); // Get form action
		...
		switch ($comprobantes_tipos->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow()) { // Add successful
					...
					$XMLDoc->AddField("x_id_comprobante", strval($comprobantes_tipos->id_comprobante->DbValue));
					$XMLDoc->AddField("x_nombre_tipo", strval($comprobantes_tipos->nombre_tipo->FormValue));
					$XMLDoc->AddField("x_descripcion", strval($comprobantes_tipos->descripcion->FormValue));
					$XMLDoc->EndRow();
					ob_end_clean();

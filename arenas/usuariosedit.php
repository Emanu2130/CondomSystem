...
usuarios_edit.SelectAllKey = function(elem) {
	ew_SelectAll(elem);
}
...
<p><span class="arenas">Editar Modulo: Usuarios<br><br>
<a href="<?php echo $usuarios->getReturnUrl() ?>">Volver</a></span></p>
<?php $usuarios_edit->ShowMessage() ?>
...
<?php if ($usuarios->user_id->Visible) { // user_id ?>
	<tr<?php echo $usuarios->user_id->RowAttributes ?>>
		...
		<td<?php echo $usuarios->user_id->CellAttributes() ?>><span id="el_user_id">
<div<?php echo $usuarios->user_id->ViewAttributes() ?>><?php echo $usuarios->user_id->EditValue ?></div><input type="hidden" name="x_user_id" id="x_user_id" value="<?php echo ew_HtmlEncode($usuarios->user_id->CurrentValue) ?>">
</span><?php echo $usuarios->user_id->CustomMsg ?></td>
	</tr>
<?php } ?>
...
class cusuarios_edit {
	...
	function Page_Main() {
		...
		// Check if valid key
		if ($usuarios->user_id->CurrentValue == "")
	...
	function RenderRow() {
		...
		if ($usuarios->RowType == EW_ROWTYPE_VIEW) { // View row
			...
			$usuarios->user_id->EditValue = $usuarios->user_id->CurrentValue;
			$usuarios->user_id->CssStyle = "";
			$usuarios->user_id->CssClass = "";
			$usuarios->user_id->ViewCustomAttributes = "";

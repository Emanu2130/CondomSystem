...
// Define page object
$ingresos_edit = new cingresos_edit();
$Page =& $ingresos_edit;

// Page init processing
$ingresos_edit->Page_Init();

// Page main processing
$ingresos_edit->Page_Main();
?>
...
// Create page object
var ingresos_edit = new ew_Page("ingresos_edit");

// page properties
ingresos_edit.PageID = "edit"; // page ID
var EW_PAGE_ID = ingresos_edit.PageID; // for backward compatibility

// extend page with ValidateForm function
ingresos_edit.ValidateForm = function(fobj) {
...
ingresos_edit.Form_CustomValidate = 
 function(fobj) { // DO NOT CHANGE THIS LINE!

 	// Your custom validation code here, return false if invalid. 
 	return true;
 }
ingresos_edit.SelectAllKey = function(elem) {
	ew_SelectAll(elem);
}
<?php if (EW_CLIENT_VALIDATE) { ?>
ingresos_edit.ValidateRequired = true; // uses JavaScript validation
<?php } else { ?>
ingresos_edit.ValidateRequired = false; // no JavaScript validation
<?php } ?>
...
<p><span class="arenas">Editar Modulo: Ingresos<br><br>
<a href="<?php echo $ingresos->getReturnUrl() ?>">Volver</a></span></p>
<?php $ingresos_edit->ShowMessage() ?>
<form name="fingresosedit" id="fingresosedit" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return ingresos_edit.ValidateForm(this);">
<p>
<input type="hidden" name="a_table" id="a_table" value="ingresos">
...
<?php if ($ingresos->id_ingreso->Visible) { // id_ingreso ?>
	<tr<?php echo $ingresos->id_ingreso->RowAttributes ?>>
		...
		<td<?php echo $ingresos->id_ingreso->CellAttributes() ?>><span id="el_id_ingreso">
<div<?php echo $ingresos->id_ingreso->ViewAttributes() ?>><?php echo $ingresos->id_ingreso->EditValue ?></div><input type="hidden" name="x_id_ingreso" id="x_id_ingreso" value="<?php echo ew_HtmlEncode($ingresos->id_ingreso->CurrentValue) ?>">
</span><?php echo $ingresos->id_ingreso->CustomMsg ?></td>
	</tr>
<?php } ?>
...
&nbsp;<a name="aol_x_tipo_ingreso" id="aol_x_tipo_ingreso" href="javascript:void(0);" onclick="ew_AddOptDialogShow({pg:ingresos_edit,lnk:'aol_x_tipo_ingreso',el:'x_tipo_ingreso',hdr:this.innerHTML, url:'ingresos_tiposaddopt.php',lf:'x_id_ingresos',df:'x_nombre',df2:'',pf:'',ff:''});">Agregar Tipo Ingreso</a>
...
&nbsp;<a name="aol_x_Empresa" id="aol_x_Empresa" href="javascript:void(0);" onclick="ew_AddOptDialogShow({pg:ingresos_edit,lnk:'aol_x_Empresa',el:'x_Empresa',hdr:this.innerHTML, url:'empresasaddopt.php',lf:'x_id_empresa',df:'x_nombre',df2:'',pf:'',ff:''});">Agregar Empresa</a>
...
&nbsp;<a name="aol_x_tipo_comprobante" id="aol_x_tipo_comprobante" href="javascript:void(0);" onclick="ew_AddOptDialogShow({pg:ingresos_edit,lnk:'aol_x_tipo_comprobante',el:'x_tipo_comprobante',hdr:this.innerHTML, url:'comprobantes_tiposaddopt.php',lf:'x_nombre_tipo',df:'x_nombre_tipo',df2:'',pf:'',ff:''});">Agregar Tipo Comprobante</a>
...
&nbsp;<a name="aol_x_locacion" id="aol_x_locacion" href="javascript:void(0);" onclick="ew_AddOptDialogShow({pg:ingresos_edit,lnk:'aol_x_locacion',el:'x_locacion[]',hdr:this.innerHTML, url:'locacionesaddopt.php',lf:'x_id_locacion',df:'x_nombre',df2:'',pf:'',ff:''});">Agregar Locacion</a>
<?php } ?>
...
&nbsp;<a name="aol_x_cuenta_banco" id="aol_x_cuenta_banco" href="javascript:void(0);" onclick="ew_AddOptDialogShow({pg:ingresos_edit,lnk:'aol_x_cuenta_banco',el:'x_cuenta_banco',hdr:this.innerHTML, url:'cuentas_bancariasaddopt.php',lf:'x_id_banco',df:'x_Banco',df2:'x_numero_cuenta',pf:'',ff:''});">Agregar Cuenta Banco</a>
...
&nbsp;<a name="aol_x_proveedor" id="aol_x_proveedor" href="javascript:void(0);" onclick="ew_AddOptDialogShow({pg:ingresos_edit,lnk:'aol_x_proveedor',el:'x_proveedor',hdr:this.innerHTML, url:'proveedoresaddopt.php',lf:'x_id_proveedor',df:'x_nombre',df2:'',pf:'',ff:''});">Agregar Proveedor</a>
<?php } ?>
...
class cingresos_edit {
	...
	function Page_Main() {
		...
		if (@$_POST["a_edit"] <> "") {
			$ingresos->CurrentAction = $_POST["a_edit"]; // Get action code
			$this->LoadFormValues(); // Get form values

			// Validate Form
			if (!$this->ValidateForm()) {
				$ingresos->CurrentAction = ""; // Form error, reset action
				$this->setMessage($gsFormError);
			}
		} else {
			$ingresos->CurrentAction = "I"; // Default action is display
		}

		// Check if valid key
		if ($ingresos->id_ingreso->CurrentValue == "")
			$this->Page_Terminate("ingresoslist.php"); // Invalid key, return to list
		switch ($ingresos->CurrentAction) {
			case "I": // Get a record to display
				...
				break;
			Case "U": // Update
				$ingresos->SendEmail = TRUE; // Send email on update success
		...
		// Render the record
		$ingresos->RowType = EW_ROWTYPE_EDIT; // Render as edit
		$this->RenderRow();
	}

...
/**
 * MySQL API for Arenas 6
 * (C) 2002-2008 FSLD.org Technology Limited
 *
 * This script (ewmysql*.php) is based on:
 * V1.42 ADOdb Lite 11 January 2007 (C) 2005-2007 Mark Dickenson. Released LGPL.
 */
$PHPMaker_vers = 'v6.0.0 Arenas (C) 2002-2008 FSLD.org Technology Limited';
...
class ADOConnection
{
	...
	/**
	 * Returns floating point version number of Arenas
	 * Usage: $db->Version();
	 * 
	 * @access public 
	 */

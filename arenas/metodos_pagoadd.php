...
// Define page object
$metodos_pago_add = new cmetodos_pago_add();
$Page =& $metodos_pago_add;

// Page init processing
$metodos_pago_add->Page_Init();

// Page main processing
$metodos_pago_add->Page_Main();
?>
...
// Create page object
var metodos_pago_add = new ew_Page("metodos_pago_add");

// page properties
metodos_pago_add.PageID = "add"; // page ID
var EW_PAGE_ID = metodos_pago_add.PageID; // for backward compatibility

// extend page with ValidateForm function
metodos_pago_add.ValidateForm = function(fobj) {
...
metodos_pago_add.Form_CustomValidate = 
 function(fobj) { // DO NOT CHANGE THIS LINE!

 	// Your custom validation code here, return false if invalid. 
 	return true;
 }
metodos_pago_add.SelectAllKey = function(elem) {
	ew_SelectAll(elem);
}
<?php if (EW_CLIENT_VALIDATE) { ?>
metodos_pago_add.ValidateRequired = true; // uses JavaScript validation
<?php } else { ?>
metodos_pago_add.ValidateRequired = false; // no JavaScript validation
<?php } ?>
...
<p><span class="arenas">Agregar Modulo: Metodos Pago<br><br>
<a href="<?php echo $metodos_pago->getReturnUrl() ?>">Volver</a></span></p>
<?php $metodos_pago_add->ShowMessage() ?>
<form name="fmetodos_pagoadd" id="fmetodos_pagoadd" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return metodos_pago_add.ValidateForm(this);">
<p>
...
class cmetodos_pago_add {
	...
	// Page Object Name
	var $PageObjName = 'metodos_pago_add';
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
		   $metodos_pago->CurrentAction = $_POST["a_add"]; // Get form action
		  ...
		  if ($bCopy) {
		    $metodos_pago->CurrentAction = "C"; // Copy Record
		  } else {

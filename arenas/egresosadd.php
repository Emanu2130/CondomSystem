...
// Define page object
$egresos_add = new cegresos_add();
$Page =& $egresos_add;

// Page init processing
$egresos_add->Page_Init();

// Page main processing
$egresos_add->Page_Main();
?>
...
// Create page object
var egresos_add = new ew_Page("egresos_add");

// page properties
egresos_add.PageID = "add"; // page ID
var EW_PAGE_ID = egresos_add.PageID; // for backward compatibility

// extend page with ValidateForm function
egresos_add.ValidateForm = function(fobj) {
...
egresos_add.Form_CustomValidate = 
 function(fobj) { // DO NOT CHANGE THIS LINE!

 	// Your custom validation code here, return false if invalid. 
 	return true;
 }
egresos_add.SelectAllKey = function(elem) {
	ew_SelectAll(elem);
}
<?php if (EW_CLIENT_VALIDATE) { ?>
egresos_add.ValidateRequired = true; // uses JavaScript validation
<?php } else { ?>
egresos_add.ValidateRequired = false; // no JavaScript validation
<?php } ?>
...
<p><span class="arenas">Agregar Modulo: Egresos<br><br>
<a href="<?php echo $egresos->getReturnUrl() ?>">Volver</a></span></p>
<?php $egresos_add->ShowMessage() ?>
<form name="fegresosadd" id="fegresosadd" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return egresos_add.ValidateForm(this);">
<p>
...
&nbsp;<a name="aol_x_tipo_comprobante" id="aol_x_tipo_comprobante" href="javascript:void(0);" onclick="ew_AddOptDialogShow({pg:egresos_add,lnk:'aol_x_tipo_comprobante',el:'x_tipo_comprobante',hdr:this.innerHTML, url:'comprobantes_tiposaddopt.php',lf:'x_nombre_tipo',df:'x_nombre_tipo',df2:'',pf:'',ff:''});">Agregar Tipo Comprobante</a>
...
&nbsp;<a name="aol_x_Metodo_pago" id="aol_x_Metodo_pago" href="javascript:void(0);" onclick="ew_AddOptDialogShow({pg:egresos_add,lnk:'aol_x_Metodo_pago',el:'x_Metodo_pago',hdr:this.innerHTML, url:'metodos_pagoaddopt.php',lf:'x_id_metodo',df:'x_metodo',df2:'',pf:'',ff:''});">Agregar Metodo Pago</a>
...
&nbsp;<a name="aol_x_proveedor" id="aol_x_proveedor" href="javascript:void(0);" onclick="ew_AddOptDialogShow({pg:egresos_add,lnk:'aol_x_proveedor',el:'x_proveedor',hdr:this.innerHTML, url:'proveedoresaddopt.php',lf:'x_id_proveedor',df:'x_nombre',df2:'',pf:'',ff:''});">Agregar Proveedor</a>
<?php } ?>
...
&nbsp;<a name="aol_x_tipo1" id="aol_x_tipo1" href="javascript:void(0);" onclick="ew_AddOptDialogShow({pg:egresos_add,lnk:'aol_x_tipo1',el:'x_tipo1',hdr:this.innerHTML, url:'egresos_tipo1addopt.php',lf:'x_id_tipo',df:'x_tipo',df2:'',pf:'',ff:''});">Agregar Tipo egreso</a>
...
&nbsp;<a name="aol_x_Empresa" id="aol_x_Empresa" href="javascript:void(0);" onclick="ew_AddOptDialogShow({pg:egresos_add,lnk:'aol_x_Empresa',el:'x_Empresa',hdr:this.innerHTML, url:'empresasaddopt.php',lf:'x_id_empresa',df:'x_nombre',df2:'',pf:'',ff:''});">Agregar Empresa</a>
...
&nbsp;<a name="aol_x_locacion" id="aol_x_locacion" href="javascript:void(0);" onclick="ew_AddOptDialogShow({pg:egresos_add,lnk:'aol_x_locacion',el:'x_locacion[]',hdr:this.innerHTML, url:'locacionesaddopt.php',lf:'x_id_locacion',df:'x_nombre',df2:'',pf:'',ff:''});">Agregar Locacion</a>
<?php } ?>
...
&nbsp;<a name="aol_x_cuenta_banco" id="aol_x_cuenta_banco" href="javascript:void(0);" onclick="ew_AddOptDialogShow({pg:egresos_add,lnk:'aol_x_cuenta_banco',el:'x_cuenta_banco',hdr:this.innerHTML, url:'cuentas_bancariasaddopt.php',lf:'x_id_banco',df:'x_Banco',df2:'x_numero_cuenta',pf:'',ff:''});">Agregar Cuenta Banco</a>
...
class cegresos_add {
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
		   $egresos->CurrentAction = $_POST["a_add"]; // Get form action
		  $this->LoadFormValues(); // Load form values

			// Validate Form
			if (!$this->ValidateForm()) {
				$egresos->CurrentAction = "I"; // Form error, reset action
				$this->setMessage($gsFormError);
			}
		} else { // Not post back
		  if ($bCopy) {
		    $egresos->CurrentAction = "C"; // Copy Record
		  } else {
		    $egresos->CurrentAction = "I"; // Display Blank Record
		...
		switch ($egresos->CurrentAction) {
		  ...
		  case "A": // ' Add new record
				$egresos->SendEmail = TRUE; // Send email on add success
		...
		$egresos->RowType = EW_ROWTYPE_ADD;  // Render add type
